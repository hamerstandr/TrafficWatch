...
namespace WindowsDesktop
{
	public static class WindowExtensions
	{
		...
		/// </summary>
		internal static IntPtr GetHandle(this Window visual)
		{
			IntPtr windowHandle = new WindowInteropHelper(visual).Handle;
			if (windowHandle == null) throw new InvalidOperationException();
